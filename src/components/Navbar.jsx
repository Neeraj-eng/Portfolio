...
const navLinks = [
  ...
  { title: "Programing", path: "#programing" },
        ...
        <div className="mobile-menu block md:hidden">
          {!navbarOpen ? (
            <button
              ...
              className="flex text-slate-200 items-center px-2 py-2 border rounded border-slate-200 hover:text-white hover:border-white"
            >
              <svg
